...
from infer_yolo_v9_seg.infer_yolo_v9_seg_process import InferYoloV9SegParam
...
# --------------------
class InferYoloV9SegWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferYoloV9SegParam()
        else:
        ...
        self.combo_model.addItem("yolov9c-seg")
        self.combo_model.addItem("yolov9e-seg")
...
# --------------------
class InferYoloV9SegWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_yolo_v9_seg"

    def create(self, param):
        # Create widget object
        return InferYoloV9SegWidget(param, None)
